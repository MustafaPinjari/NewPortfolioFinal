...
import { Dock, DockIcon } from '@/app/registry/magicui/dock';
...
const DATA = {
  ...
  contact: {
    social: {
      GitHub: {
        name: 'GitHub',
        url: 'https://github.com/MustafaPinjari',
        icon: Icons.github,
      },
      LinkedIn: {
        name: 'LinkedIn',
        url: 'https://linkedin.com/in/mustafapinjari',
        icon: Icons.linkedin,
      },
      X: {
        name: 'X',
        url: 'https://x.com/mustafapinjari',
        icon: Icons.x,
      },
      YouTube: {
        name: 'YouTube',
        url: 'https://youtube.com/@techbukky?si=PkcVZjeog5er54jp',
        icon: Icons.youtube,
      },
      WhatsApp: {
        name: 'WhatsApp',
        url: 'https://wa.me/917798849225',
        icon: Icons.whatsapp,
      },
      email: {
        name: 'Send Email',
        url: 'mailto:mustafapinjari@gmail.com',
        icon: Icons.email,
      },
    },
  },
